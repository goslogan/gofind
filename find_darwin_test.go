...
var testFS = fstest.MapFS{
	...
	"test/other": &fstest.MapFile{
		ModTime: time.Date(2025, time.January, 9, 7, 11, 31, 0, time.UTC),
		Mode:    fs.FileMode(fs.ModeDir | 0o755),
		Sys: &syscall.Stat_t{
			Dev:           16777232,
			Ino:           8538127,
			...
			Blksize:       4096,
			Blocks:        0,
			Atimespec:     syscall.Timespec{Sec: time.Date(2025, time.January, 9, 7, 11, 31, 0, time.UTC).Unix()},
			Mtimespec:     syscall.Timespec{Sec: time.Date(2025, time.January, 9, 7, 11, 31, 0, time.UTC).Unix()},
			Ctimespec:     syscall.Timespec{Sec: time.Date(2025, time.January, 9, 7, 11, 31, 0, time.UTC).Unix()},
			Birthtimespec: syscall.Timespec{Sec: time.Date(2025, time.January, 6, 11, 9, 12, 0, time.UTC).Unix()},
		},
	},
